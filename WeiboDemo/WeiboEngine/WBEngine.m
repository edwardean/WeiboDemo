...
- (void)readAuthorizeDataFromKeychain
{
    ...
    NSLog(@"serviceName:%@ Read:userID:%@ accessToken:%@ expireTime:%f",serviceName,userID,accessToken,expireTime);
}
...
{
    bug;
    NSLog(@"userID:%@ accessToken:%@ expireTime:%f ",userID,accessToken,expireTime);
    //    return userID && accessToken && refreshToken;
    //return userID && accessToken && (expireTime > 0);
    return ![self isAuthorizeExpired]&&userID && accessToken;
}
